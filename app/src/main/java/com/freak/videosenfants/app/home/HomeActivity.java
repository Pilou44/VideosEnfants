...
import com.freak.videosenfants.activities.AboutActivity;
import com.freak.videosenfants.activities.FaqActivity;
...
public class HomeActivity extends BaseActivity implements HomeContract.View, View.OnClickListener {
    ...
    private Boolean mUpnpAvailable = false; // ToDo null when Upnp coded
    ...
    protected void onResume() {
        ...
        mPresenter.retrieveAvailableSources();
    ...
    @Override
    public void notifyLocalSourcesAvailable(boolean localAvailable) {
        mLocalAvailable = localAvailable;
        continueLoading();
    }

    private void continueLoading() {
        if (mLocalAvailable != null && mUpnpAvailable != null) {
            ...
            if (!mLocalAvailable && !mUpnpAvailable) {
                mOptions.setVisibility(View.VISIBLE);
            }
            else {
                mOptions.setVisibility(View.GONE);
